...
QVariant ObjectTreeModel::data(const QModelIndex &index, int role) const
{
    ...
    else if (role == Qt::ToolTipRole)
    {
        ...
        {
        case 0:
            return QString("Object:%1").arg(static_cast<QObject*>(index.internalPointer())->objectName());
        case 1:
            return QString("Class:%1").arg(static_cast<QObject*>(index.internalPointer())->metaObject()->className());
        default:
            break;
        }
    }
